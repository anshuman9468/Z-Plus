...
import { LayoutDashboard, Upload, History, ShieldCheck, Settings, LogOut, TrendingUp, Sparkles } from 'lucide-react';
...
export function Sidebar({ currentPage, onNavigate }: SidebarProps) {
  const menuItems = [
    ...
    { icon: Sparkles, label: 'Data Cleaning', page: 'cleaning' as Page },
